...
const form = document.querySelector('#form-vali');
...
const checkPassword = () => {
    ...
    if (!isRequired(password)) {
        ...
        showError(passwordEl, 'Password must has at least 8 numeric characters !');
    } else {
...
if(formEdit) {
    ...
    formEdit.addEventListener('input', debounce(function (e) {
        switch (e.target.id) {
            case 'username':
                checkUsername();
                break;
